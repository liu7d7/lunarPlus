...
public class TileEntityBanner extends TileEntity
{
    ...
    public void setItemValues(ItemStack stack)
    {
        ...
        if (stack.hasTagCompound() && stack.getTagCompound().hasKey("BlockEntityTag", 10))
        {
            ...
            if (nbttagcompound.hasKey("Mod", 99))
            {
                this.baseColor = nbttagcompound.getInteger("Mod");
            }
            else
            {
    ...
    {
        p_181020_0_.setInteger("Mod", p_181020_1_);
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.baseColor = compound.getInteger("Mod");
    ...
    public static int getBaseColor(ItemStack stack)
    {
        ...
        return nbttagcompound != null && nbttagcompound.hasKey("Mod") ? nbttagcompound.getInteger("Mod") : stack.getMetadata();
    }

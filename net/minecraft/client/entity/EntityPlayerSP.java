...
import me.ethius.lunarplus.event.impl.player.MotionUpdateEvent;
import me.ethius.lunarplus.event.impl.player.MoveEvent;
import me.ethius.lunarplus.event.impl.player.UpdateActionEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        MotionUpdateEvent event = new MotionUpdateEvent(this.mc.thePlayer.posX, this.getEntityBoundingBox().minY, this.mc.thePlayer.posZ, this.mc.thePlayer.rotationYaw, this.mc.thePlayer.rotationPitch, this.mc.thePlayer.onGround, Event.State.PRE);
        event.call();

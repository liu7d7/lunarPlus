...
public class RenderUtil {
    ...
    public static void endSmooth() {
        ...
        public static void drawBlockBox(final BlockPos blockPos, final Color color, final boolean outline) {
            ...
            drawFilledBox(axisAlignedBB, color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
        ...
        public static void drawSelectionBoundingBox(AxisAlignedBB boundingBox) {
            ...
            worldrenderer.begin(GL_LINE_STRIP, POSITION);
        ...
        public static void drawFilledBox(final AxisAlignedBB axisAlignedBB, float red, float blue, float green, float alpha) {
        ...
        public static void drawModalRectWithCustomSizedTexture(float x, float y, float u, float v, float width, float height, float textureWidth, float textureHeight) {
            ...
            Tessellator tessellator = Tessellator.getInstance();
            WorldRenderer worldrenderer = tessellator.getWorldRenderer();
            worldrenderer.begin(7, POSITION_TEX);
        ...
        public static void draw2D(final EntityLivingBase entity, final double posX, final double posY, final double posZ, final int color, final int backgroundColor) {
            ...
            GL11.glRotated(-Minecraft.getMinecraft().getRenderManager().playerViewY, 0F, 1F, 0F);
